...
public class FuncionarioService {
	...
	public List<Funcionario> findByParteNome(String nome){
		return this.funcionarioRepository.findByParteNome(nome);
	}
	...
	public List<Funcionario> findByFuncionario(long id){
		Funcionario funcionario = new Funcionario();
		funcionario.setId(id);
		return this.funcionarioRepository.findByFuncionario(funcionario);
	}
}
...
public interface ClienteRepository extends JpaRepository<Cliente, Long>{
	...
	public List<Cliente> findByParteNome(String nome);
	...
	@Query("SELECT e FROM Cliente e WHERE e.nome LIKE %:parteNome%")
	List<Cliente> buscarParteNome(@Param("parteNome") String parteNome);
